...
import com.gdglc.hzqmes.security.model.token.RefreshToken;
...
public class RefreshTokenEndpoint {
    ...
    JwtToken refreshToken(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        Users user = userService.getUserByUsername(subject).orElseThrow(() -> new UsernameNotFoundException("User not found: " + subject));
